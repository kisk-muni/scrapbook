  ...
  return (
    <div className="mx-auto sm:max-w-2xl mt-6 mb-8 px-4 sm:mt-6 sm:mb-16 sm:px-6 md:mt-8 md:mb-20">
      <div className="justify-center">
        <h1 className="text-4xl mb-4 tracking-tight text-text sm:text-5xl md:text-5xl">
          <span className="block xl:inline font-extrabold">O Scrapbooku</span>
        </h1>
        <p className="mt-0 text-xl text-text mx-auto mb-4">
        ...
        <h2 className="text-3xl mt-8 mb-4 tracking-tight text-text sm:text-4xl md:text-4xl">
        ...
        <p className="mt-0 text-xl text-text mx-auto mb-4">
          ...
          <Link
            ...
            href="mailto:kramosilova@kisk.cz"
          >
            kramosilova@kisk.cz
          </Link>
          .
        ...
        <q className="mt-0 ml-6 text-xl text-text mx-auto mb-4">
