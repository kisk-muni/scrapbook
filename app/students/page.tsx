...
export default function StudentsPage() {
  return (
    <Fragment>
      <div className="flex flex-col justify-center items-center mx-auto sm:max-w-4xl mt-6 mb-8 sm:mt-6 sm:mb-16 sm:px-6 md:mt-8 md:mb-20 overflow-visible">
      ...
      <div className="ml-auto sm:max-w-8xl mb-8 sm:mb-16 md:mt-8 md:mb-20 -mr-6">
